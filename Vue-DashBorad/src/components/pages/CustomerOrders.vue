    ...
    <div class="my-5 row justify-content-center">
      <form class="col-md-6" @submit.prevent="createOrder">
        ...
        <div class="form-group">
          ...
          <input type="address" class="form-control" name="address" :class="{'is-invalid': errors.has('address')}" id="useraddress" v-model="form.user.address" v-validate="'required'" placeholder="請輸入地址">
